...
- failed_seed_rate 普遍在 0.35-0.40 附近。这不是反常现象，而是标签定义上的必然风险：`big_winner_forward` 只要求未来 H120 内有足够高的 peak return，并不要求路径平滑，也不要求 H10 内不出现短期失败。因此“更容易成为大赢家”和“短期失败风险低”本来就是两个不同问题，必须分别建模和 gating。
- 这更像是“强势状态提升 winner posterior”，不是“可执行、低回撤、可进入 R03 的 evidence family”。

完整 31 个 Stage B candidates 表现如下。每个 split 单元格格式为 `signal_n / signal_rate / posterior / primary_LR / EV_R / failed_seed_rate`：

| # | structure_candidate_id | action_time_definition | train_gate | T n/rate/post/LR/EV_R/fail | V n/rate/post/LR/EV_R/fail | R n/rate/post/LR/EV_R/fail |
|---:|---|---|---|---|---|---|
| 1 | `r02v2_acceleration_and_gap_persistence_813ecf_312b95_23e5f3_4e0740_f5ca38` | gap_open_pct >= 0.01; rolling_days=3; required_days=3; window=continuation_window | passed | 418/0.0023/0.2508/1.9690/0.2280/0.3995 | 80/0.0007/0.1324/2.8291/-0.5104/0.3375 | 280/0.0026/0.0929/0.9325/-1.2354/0.6321 |
| 2 | `r02v2_acceleration_and_gap_persistence_813ecf_312b95_60f76f_4e0740_f5ca38` | gap_open_pct >= 0.01; rolling_days=3; required_days=3; window=full_window | passed | 418/0.0023/0.2508/1.9690/0.2280/0.3995 | 80/0.0007/0.1324/2.8291/-0.5104/0.3375 | 280/0.0026/0.0929/0.9325/-1.2354/0.6321 |
| 3 | `r02v2_acceleration_and_gap_persistence_813ecf_312b95_23e5f3_ef2d12_f5ca38` | gap_open_pct >= 0.01; rolling_days=5; required_days=3; window=continuation_window | rejected | 1,169/0.0065/0.2506/1.9665/-0.1644/0.3841 | 311/0.0029/0.0996/2.0520/-0.5541/0.3955 | 531/0.0048/0.1600/1.7345/-0.2401/0.3861 |
| 4 | `r02v2_acceleration_and_gap_persistence_813ecf_312b95_60f76f_ef2d12_f5ca38` | gap_open_pct >= 0.01; rolling_days=5; required_days=3; window=full_window | rejected | 1,169/0.0065/0.2506/1.9665/-0.1644/0.3841 | 311/0.0029/0.0996/2.0520/-0.5541/0.3955 | 531/0.0048/0.1600/1.7345/-0.2401/0.3861 |
| 5 | `r02v2_acceleration_and_gap_point_in_window_existence_813ecf_773a15_60f76f_6b86b2_f5ca38` | gap_open_pct >= 0.03; rolling_days=1; required_days=1; window=full_window | rejected | 1,460/0.0081/0.2389/1.8461/-0.1654/0.3705 | 838/0.0077/0.0805/1.6228/-0.5050/0.2864 | 892/0.0081/0.1238/1.2865/-0.1577/0.3274 |
| 6 | `r02v2_momentum_persistence_persistence_5a4bd9_368191_23e5f3_ef2d12_f5ca38` | ret5_asof >= 0.08; rolling_days=5; required_days=3; window=continuation_window | rejected | 2,302/0.0127/0.2317/1.7738/-0.1707/0.3827 | 906/0.0083/0.0718/1.4347/-0.6122/0.3609 | 1,041/0.0095/0.0849/0.8444/0.0714/0.3564 |
| 7 | `r02v2_momentum_persistence_persistence_5a4bd9_368191_60f76f_ef2d12_f5ca38` | ret5_asof >= 0.08; rolling_days=5; required_days=3; window=full_window | rejected | 2,302/0.0127/0.2317/1.7738/-0.1707/0.3827 | 906/0.0083/0.0718/1.4347/-0.6122/0.3609 | 1,041/0.0095/0.0849/0.8444/0.0714/0.3564 |
| 8 | `r02v2_momentum_persistence_persistence_5a4bd9_368191_23e5f3_4e0740_f5ca38` | ret5_asof >= 0.08; rolling_days=3; required_days=3; window=continuation_window | rejected | 2,025/0.0112/0.2219/1.6771/-0.2284/0.3906 | 786/0.0072/0.0726/1.4517/-0.5526/0.3715 | 924/0.0084/0.0750/0.7383/0.1055/0.3690 |
| 9 | `r02v2_momentum_persistence_persistence_5a4bd9_368191_60f76f_4e0740_f5ca38` | ret5_asof >= 0.08; rolling_days=3; required_days=3; window=full_window | rejected | 2,025/0.0112/0.2219/1.6771/-0.2284/0.3906 | 786/0.0072/0.0726/1.4517/-0.5526/0.3715 | 924/0.0084/0.0750/0.7383/0.1055/0.3690 |
| 10 | `r02v2_momentum_persistence_point_in_window_existence_5a4bd9_368191_156070_6b86b2_f5ca38` | ret5_asof >= 0.08; rolling_days=1; required_days=1; window=build_window | rejected | 3,702/0.0204/0.2055/1.5214/-0.1804/0.3522 | 1,684/0.0155/0.0721/1.4411/-0.5528/0.3361 | 1,649/0.0151/0.1173/1.2096/0.3018/0.2771 |
| 11 | `r02v2_momentum_persistence_point_in_window_existence_5a4bd9_368191_23e5f3_6b86b2_f5ca38` | ret5_asof >= 0.08; rolling_days=1; required_days=1; window=continuation_window | rejected | 3,702/0.0204/0.2055/1.5214/-0.1804/0.3522 | 1,684/0.0155/0.0721/1.4411/-0.5528/0.3361 | 1,649/0.0151/0.1173/1.2096/0.3018/0.2771 |
| 12 | `r02v2_momentum_persistence_point_in_window_existence_5a4bd9_368191_60f76f_6b86b2_f5ca38` | ret5_asof >= 0.08; rolling_days=1; required_days=1; window=full_window | rejected | 3,702/0.0204/0.2055/1.5214/-0.1804/0.3522 | 1,684/0.0155/0.0721/1.4411/-0.5528/0.3361 | 1,649/0.0151/0.1173/1.2096/0.3018/0.2771 |
| 13 | `r02v2_momentum_persistence_point_in_window_existence_5a4bd9_368191_a96cae_6b86b2_f5ca38` | ret5_asof >= 0.08; rolling_days=1; required_days=1; window=early_window | rejected | 3,702/0.0204/0.2055/1.5214/-0.1804/0.3522 | 1,684/0.0155/0.0721/1.4411/-0.5528/0.3361 | 1,649/0.0151/0.1173/1.2096/0.3018/0.2771 |
| 14 | `r02v2_momentum_persistence_persistence_5a4bd9_0602d7_156070_4e0740_f5ca38` | ret5_asof >= 0.05; rolling_days=3; required_days=3; window=build_window | rejected | 3,448/0.0190/0.1940/1.4154/-0.1216/0.3298 | 1,623/0.0149/0.0639/1.2652/-0.5706/0.3303 | 1,737/0.0159/0.0995/1.0059/0.0999/0.2844 |
| 15 | `r02v2_momentum_persistence_persistence_5a4bd9_0602d7_23e5f3_4e0740_f5ca38` | ret5_asof >= 0.05; rolling_days=3; required_days=3; window=continuation_window | rejected | 3,448/0.0190/0.1940/1.4154/-0.1216/0.3298 | 1,623/0.0149/0.0639/1.2652/-0.5706/0.3303 | 1,737/0.0159/0.0995/1.0059/0.0999/0.2844 |
| 16 | `r02v2_relative_strength_confirmation_persistence_59f3c8_1e9d7c_156070_4e0740_f5ca38` | rps5 > 0.8; rolling_days=3; required_days=3; window=build_window | rejected | 3,805/0.0210/0.1855/1.3398/-0.1461/0.3130 | 2,337/0.0214/0.0596/1.1754/-0.7441/0.2974 | 2,329/0.0213/0.1016/1.0293/0.0207/0.2198 |
| 17 | `r02v2_relative_strength_confirmation_persistence_59f3c8_1e9d7c_23e5f3_4e0740_f5ca38` | rps5 > 0.8; rolling_days=3; required_days=3; window=continuation_window | rejected | 3,805/0.0210/0.1855/1.3398/-0.1461/0.3130 | 2,337/0.0214/0.0596/1.1754/-0.7441/0.2974 | 2,329/0.0213/0.1016/1.0293/0.0207/0.2198 |
| 18 | `r02v2_acceleration_and_gap_point_in_window_existence_813ecf_312b95_156070_6b86b2_f5ca38` | gap_open_pct >= 0.01; rolling_days=1; required_days=1; window=build_window | rejected | 5,360/0.0296/0.1802/1.2926/-0.1643/0.2767 | 2,789/0.0256/0.0671/1.3349/-0.5044/0.2937 | 2,374/0.0217/0.1202/1.2444/0.2379/0.2190 |
| 19 | `r02v2_acceleration_and_gap_point_in_window_existence_813ecf_312b95_23e5f3_6b86b2_f5ca38` | gap_open_pct >= 0.01; rolling_days=1; required_days=1; window=continuation_window | rejected | 5,360/0.0296/0.1802/1.2926/-0.1643/0.2767 | 2,789/0.0256/0.0671/1.3349/-0.5044/0.2937 | 2,374/0.0217/0.1202/1.2444/0.2379/0.2190 |
| 20 | `r02v2_acceleration_and_gap_point_in_window_existence_813ecf_312b95_a96cae_6b86b2_f5ca38` | gap_open_pct >= 0.01; rolling_days=1; required_days=1; window=early_window | rejected | 5,360/0.0296/0.1802/1.2926/-0.1643/0.2767 | 2,789/0.0256/0.0671/1.3349/-0.5044/0.2937 | 2,374/0.0217/0.1202/1.2444/0.2379/0.2190 |
| 21 | `r02v2_near_high_persistence_persistence_4b3435_8aed64_23e5f3_ef2d12_f5ca38` | close_near_high20_pct >= 0.0; rolling_days=5; required_days=3; window=continuation_window | passed | 3,078/0.0170/0.1702/1.2062/-0.0631/0.3034 | 1,493/0.0137/0.0563/1.1058/-0.5632/0.2257 | 1,918/0.0175/0.0732/0.7193/0.2367/0.2059 |
| 22 | `r02v2_near_high_persistence_persistence_4b3435_8aed64_60f76f_ef2d12_f5ca38` | close_near_high20_pct >= 0.0; rolling_days=5; required_days=3; window=full_window | passed | 3,078/0.0170/0.1702/1.2062/-0.0631/0.3034 | 1,493/0.0137/0.0563/1.1058/-0.5632/0.2257 | 1,918/0.0175/0.0732/0.7193/0.2367/0.2059 |
| 23 | `r02v2_near_high_persistence_persistence_4b3435_8aed64_23e5f3_4e0740_f5ca38` | close_near_high20_pct >= 0.0; rolling_days=3; required_days=3; window=continuation_window | passed | 2,336/0.0129/0.1671/1.1801/-0.0562/0.3104 | 1,078/0.0099/0.0496/0.9689/-0.5166/0.2161 | 1,406/0.0128/0.0675/0.6594/0.3388/0.1977 |
| 24 | `r02v2_near_high_persistence_persistence_4b3435_8aed64_60f76f_4e0740_f5ca38` | close_near_high20_pct >= 0.0; rolling_days=3; required_days=3; window=full_window | passed | 2,336/0.0129/0.1671/1.1801/-0.0562/0.3104 | 1,078/0.0099/0.0496/0.9689/-0.5166/0.2161 | 1,406/0.0128/0.0675/0.6594/0.3388/0.1977 |
| 25 | `r02v2_near_high_persistence_persistence_29a6c7_8aed64_156070_4e0740_f5ca38` | close_near_high5_pct >= 0.0; rolling_days=3; required_days=3; window=build_window | rejected | 4,037/0.0223/0.1502/1.0396/-0.0790/0.2675 | 2,113/0.0194/0.0536/1.0498/-0.7383/0.2168 | 2,435/0.0222/0.0833/0.8273/0.2248/0.1786 |
| 26 | `r02v2_volume_money_confirmation_persistence_e071ce_9f29a1_23e5f3_4e0740_f5ca38` | money_ratio20_mean_asof > 1.5; rolling_days=3; required_days=3; window=continuation_window | rejected | 2,193/0.0121/0.1475/1.0173/-0.0223/0.2690 | 1,031/0.0095/0.0732/1.4649/-0.5574/0.2629 | 1,352/0.0123/0.0957/0.9631/0.3934/0.2219 |
| 27 | `r02v2_volume_money_confirmation_persistence_e071ce_9f29a1_60f76f_4e0740_f5ca38` | money_ratio20_mean_asof > 1.5; rolling_days=3; required_days=3; window=full_window | rejected | 2,193/0.0121/0.1475/1.0173/-0.0223/0.2690 | 1,031/0.0095/0.0732/1.4649/-0.5574/0.2629 | 1,352/0.0123/0.0957/0.9631/0.3934/0.2219 |
| 28 | `r02v2_volume_money_confirmation_persistence_e071ce_9f29a1_23e5f3_ef2d12_f5ca38` | money_ratio20_mean_asof > 1.5; rolling_days=5; required_days=3; window=continuation_window | rejected | 2,935/0.0162/0.1467/1.0114/0.0039/0.2627 | 1,479/0.0136/0.0663/1.3172/-0.5200/0.2603 | 1,733/0.0158/0.0956/0.9626/0.4798/0.2043 |
| 29 | `r02v2_volume_money_confirmation_persistence_e071ce_9f29a1_60f76f_ef2d12_f5ca38` | money_ratio20_mean_asof > 1.5; rolling_days=5; required_days=3; window=full_window | rejected | 2,935/0.0162/0.1467/1.0114/0.0039/0.2627 | 1,479/0.0136/0.0663/1.3172/-0.5200/0.2603 | 1,733/0.0158/0.0956/0.9626/0.4798/0.2043 |
| 30 | `r02v2_volume_money_confirmation_persistence_e071ce_77ac31_156070_4e0740_f5ca38` | money_ratio20_mean_asof > 1.2; rolling_days=3; required_days=3; window=build_window | rejected | 4,025/0.0222/0.1452/0.9992/-0.0943/0.2559 | 2,152/0.0197/0.0576/1.1338/-0.5608/0.2509 | 2,490/0.0227/0.0929/0.9321/0.3976/0.2108 |
| 31 | `r02v2_volume_money_confirmation_persistence_e071ce_77ac31_a96cae_4e0740_f5ca38` | money_ratio20_mean_asof > 1.2; rolling_days=3; required_days=3; window=early_window | rejected | 4,025/0.0222/0.1452/0.9992/-0.0943/0.2559 | 2,152/0.0197/0.0576/1.1338/-0.5608/0.2509 | 2,490/0.0227/0.0929/0.9321/0.3976/0.2108 |
