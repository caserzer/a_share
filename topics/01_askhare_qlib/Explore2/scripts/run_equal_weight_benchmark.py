...
from explore2_utils import flatten_risk_summary, indicator_summary, relpath, risk_summary, topic_path


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Explore2 static-universe monthly equal-weight benchmark.")
    ...
    parser.add_argument("--output-dir", default="Explore2/outputs/backtests/equal_weight_monthly")
    parser.add_argument("--summary", default="Explore2/outputs/reports/equal_weight_monthly_summary.csv")
