...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Explore2 Alpha360 prediction TopK/n_drop grid backtests.")
    ...
    parser.add_argument("--experiment-name", default="alpha360_lightgbm_mcap500")
    ...
    parser.add_argument("--topk", nargs="+", type=int, default=[20, 30, 50, 80, 100, 150])
    parser.add_argument("--n-drop", nargs="+", type=int, default=[1, 3, 5, 10, 20])
    ...
    parser.add_argument("--output-dir", default="Explore2/outputs/backtests/alpha360_grid")
    parser.add_argument("--summary", default="Explore2/outputs/reports/alpha360_topk_grid_summary.csv")
