...
FACTOR_NAME = "Close_Momentum_5D"
LOOKBACK = 5


def calculate_close_momentum_5d() -> pd.DataFrame:
    ...
    momentum = close.div(lagged_close).sub(1.0)
    momentum = momentum.where(lagged_close > 0)
